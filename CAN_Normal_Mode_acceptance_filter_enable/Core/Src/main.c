...
void CAN_Filter_config(void); //to configure acceptance filters of Rx
...
/* changing the CAN mode to running mode from initialization mode */
...
static void CAN1_Init(void){
	...
	/*
	 * For 500Kbps in 20MHZ clock signal to peripheral
	 */
	hcan1.Init.Prescaler = 4; //6;
	hcan1.Init.SyncJumpWidth = CAN_SJW_1TQ;
	...
	/*
	 * For 100MBpsin 20MHZ clock signal to peripheral
	 *
	 *
	 * hcan1.Init.Prescaler = 2; //6
		hcan1.Init.SyncJumpWidth = CAN_SJW_1TQ;
		hcan1.Init.TimeSeg1 = CAN_BS1_8TQ;
		hcan1.Init.TimeSeg2 = CAN_BS2_1TQ;
	 */
...
void CAN_Filter_config(void){
	...
	can1_filter_init.FilterMaskIdHigh = 0x01C0; // it'll block msg from specific ID mask whicyh has 000 from [3:1]
...
void CAN1_RX(void){
	...
	/* We are waiting for msg arrival */
